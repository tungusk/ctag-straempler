# Upstream README — CTAG Strämpler (original project)

This is the original README from
[ctag-fh-kiel/ctag-straempler](https://github.com/ctag-fh-kiel/ctag-straempler),
preserved as reference for this fork. See [README.md](README.md) for what this
fork is today. Licenses and credits below still apply to everything inherited
from upstream.
