...
void s2_updateStart(play_state_data_t* data, uint16_t* loopMarker, uint16_t* prevLoopMarker, const int* width, const int* height){
...
void s2_updateLoopStart(play_state_data_t* data, uint16_t* loopMarker, uint16_t* prevLoopMarker, const int* width, const int* height, const int menu_item){
...
void s2_updateLoopEnd(play_state_data_t* data, uint16_t* loopMarker, uint16_t* prevLoopMarker, const int* width, const int* height){
...
void s2_resetPrevLoopMarker(uint16_t* prevLoopMarker){
    for(int i = 0; i < 3; i++)
    {
...
void s2_updatePrevLoopMarker(uint16_t* loopMarker, uint16_t* prevLoopMarker){
    for(int i = 0; i < 3; i++)
    {
...
void s2_clearLStartMarker(uint16_t* loopMarker, const int* width, const int* height){
